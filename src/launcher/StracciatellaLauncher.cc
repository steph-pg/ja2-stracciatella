  ...
  { stracciatellaLauncher = new Fl_Double_Window(520, 380, "JA2 Stracciatella Launcher");
    ...
    { tabs = new Fl_Tabs(0, 0, 520, 350);
      ...
      { Fl_Group* o = new Fl_Group(0, 50, 520, 300, "@-> Mods ");
        o->labelcolor((Fl_Color)24);
        o->hide();
        { Fl_Group* o = new Fl_Group(10, 80, 500, 165);
        ...
        { Fl_Box* o = new Fl_Box(17, 55, 480, 20, "Mods listed later in the \"Enabled Mods\" list have higher priority.");
          o->tooltip("Higher priority mods can overwrite changes from lower-priority ones or build \
on their features.");
