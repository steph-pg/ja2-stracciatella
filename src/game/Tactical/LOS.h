...
INT8 FireBulletGivenTarget( SOLDIERTYPE * pFirer, FLOAT dEndX, FLOAT dEndY, FLOAT dEndZ, UINT16 usHandItem, INT16 sHitBy, UINT8 ubChanceToHit, UINT8 ubChanceToGetThrough, BOOLEAN fBuckshot, BOOLEAN fFake );
