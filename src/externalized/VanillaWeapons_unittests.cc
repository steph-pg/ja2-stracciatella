...
TEST(Items, ValidAttachment)
{
	...
	EXPECT_FALSE(ValidAttachment(ITEMDEFINE::QUICK_GLUE, ITEMDEFINE::TOOLKIT));
	EXPECT_FALSE(ValidAttachment(ITEMDEFINE::DUCT_TAPE, ITEMDEFINE::TOOLKIT));
	...
	EXPECT_TRUE(ValidAttachment(ITEMDEFINE::QUICK_GLUE, ITEMDEFINE::TOOLKIT));
	EXPECT_TRUE(ValidAttachment(ITEMDEFINE::DUCT_TAPE, ITEMDEFINE::TOOLKIT));
	// the repair kit is an addition, not a replacement for the steel rod combo
	EXPECT_TRUE(ValidAttachment(ITEMDEFINE::QUICK_GLUE, ITEMDEFINE::STEEL_ROD));
	EXPECT_FALSE(ValidAttachment(ITEMDEFINE::TOOLKIT, ITEMDEFINE::QUICK_GLUE));
	EXPECT_FALSE(ValidAttachment(ITEMDEFINE::CHEWING_GUM, ITEMDEFINE::TOOLKIT));
	EXPECT_FALSE(ValidAttachment(ITEMDEFINE::SUNGOGGLES, ITEMDEFINE::SPECTRA_VEST));;
	EXPECT_FALSE(ValidAttachment(ITEMDEFINE::AUTO_ROCKET_RIFLE, ITEMDEFINE::BRASS_KNUCKLES));
	EXPECT_FALSE(ValidAttachment(0xf083, 0x8c12));

	// glue and tape hide from the attachment UI, except on the kit they are meant for
	EXPECT_TRUE(HiddenAttachmentPair(ITEMDEFINE::QUICK_GLUE, ITEMDEFINE::STEEL_ROD));
	EXPECT_TRUE(HiddenAttachmentPair(ITEMDEFINE::DUCT_TAPE, ITEMDEFINE::BRASS_KNUCKLES));
	EXPECT_FALSE(HiddenAttachmentPair(ITEMDEFINE::QUICK_GLUE, ITEMDEFINE::TOOLKIT));
	EXPECT_FALSE(HiddenAttachmentPair(ITEMDEFINE::DUCT_TAPE, ITEMDEFINE::TOOLKIT));
	EXPECT_FALSE(HiddenAttachmentPair(ITEMDEFINE::TOOLKIT, ITEMDEFINE::QUICK_GLUE));

	extra_attachments = false;
	EXPECT_TRUE(HiddenAttachmentPair(ITEMDEFINE::QUICK_GLUE, ITEMDEFINE::TOOLKIT));
